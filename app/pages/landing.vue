    ...
    <section class="relative overflow-hidden pb-0">
      ...
      <div class="relative z-10 text-center pt-28 sm:pt-32 px-6">
        ...
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/[0.09] mb-7">
          ...
          <span class="text-xs font-semibold text-zinc-300">Sistema #1 para comunicação visual no Brasil</span>
        </div>
        ...
        <div class="absolute left-1/2 top-0 -translate-x-1/2 w-full max-w-[820px] bg-gradient-to-b from-[#161618] to-[#111113] border border-white/10 rounded-t-2xl shadow-[0_-10px_80px_rgba(249,115,22,0.12),0_40px_90px_rgba(0,0,0,0.6)] overflow-hidden">
          ...
          <div class="p-4 sm:p-5 grid grid-cols-4 gap-3">
            ...
            <div class="bg-[#1c1c1f] border border-white/[0.06] border-l-[3px] border-l-zinc-500 rounded-lg p-2.5">
              ...
              <p class="text-[10px] text-zinc-500 mt-1">Padaria Sol · R$ 690</p>
            </div>
            <div class="bg-[#1c1c1f] border border-white/[0.06] border-l-[3px] border-l-orange-500 rounded-lg p-2.5">
              ...
              <p class="text-[10px] text-zinc-500 mt-1">Studio Vibe · R$ 480</p>
            </div>
            <div class="bg-[#1c1c1f] border border-white/[0.06] border-l-[3px] border-l-blue-500 rounded-lg p-2.5">
              ...
              <p class="text-[10px] text-zinc-500 mt-1">Bar do Zé · R$ 320</p>
            </div>
            ...
            <div class="hidden sm:block bg-[#1c1c1f] border border-white/[0.06] border-l-[3px] border-l-zinc-500 rounded-lg p-2.5">
              ...
              <p class="text-[10px] text-zinc-500 mt-1">Ótica Vista · R$ 210</p>
            </div>
            <div class="hidden sm:block bg-[#1c1c1f] border border-white/[0.06] border-l-[3px] border-l-orange-500 rounded-lg p-2.5">
              ...
              <p class="text-[10px] text-zinc-500 mt-1">Adv. Lima · R$ 180</p>
            </div>
          </div>
        </div>
...
const plans = [
  { name: 'Essencial', desc: 'Gestão core + faturamento', price: 'R$297', period: '/mês', featured: false, url: '/login', cta: 'Começar grátis', items: ['CRM + Kanban de clientes', 'Orçamentos e OS ilimitados', 'Financeiro (pagar/receber)', 'Agendamentos', 'E-commerce (1 loja)', 'Suporte via WhatsApp'] },
  { name: 'Profissional', desc: '+ estoque/produção + Consultor IA + Marketing', price: 'R$747', period: '/mês', featured: true, url: '/login', cta: 'Começar grátis', items: ['Tudo do Essencial', 'WhatsApp integrado', 'Kanban de produção', 'Estoque e materiais', 'Marketing completo', 'Consultor IA', 'Comissões e equipe'] },
  { name: 'Enterprise', desc: '+ omnichannel, anúncios, e-commerce, IA de atendimento', price: 'R$1.997', period: '/mês', featured: false, url: 'https://wa.me/5511940527609', cta: 'Falar com consultor', items: ['Tudo do Profissional', 'WhatsApp multi-atendente', 'Integrações Meta/Google Ads', 'Múltiplas lojas e-commerce', 'IA de atendimento', 'API aberta', 'Onboarding dedicado'] },
]
