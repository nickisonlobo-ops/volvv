...
const plans = [
  ...
  { name: 'Enterprise', desc: '+ omnichannel, e-commerce, IA de atendimento', price: 'R$1.997', period: '/mês', featured: false, url: 'https://wa.me/5511940527609', cta: 'Falar com consultor', items: ['Tudo do Profissional', 'Usuários ilimitados', 'E-commerce a partir do catálogo', 'Marketplaces (Mercado Livre, Shopee, Amazon — em breve)', 'Chat unificado FB/IG/WhatsApp (em breve)', 'Criação de campanhas/anúncios FB e Google', 'Automação de marketing avançada', 'IA de atendimento nos chats (em breve)', 'White-label (marca própria)', 'Multi-posto', 'Suporte prioritário'] },
]
